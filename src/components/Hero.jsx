                ...
                <div className='absolute w-full h-[550px] bg-gradient-to-r from-black'/>
                    ...
                    <div className='absolute w-full top-[20%] p-4 md:p-8'>
                        ...
                        <div className='mt-8 mb-4'>
                            <button className='capitalize border bg-gray-300 text-black border-gray-300 py-2 px-5 ml-4'>
                                play
                            </button>
                            <button className='capitalize border text-white border-gray-300 py-2 px-5 ml-4'>
                                watch later
                            </button>
                        </div>
